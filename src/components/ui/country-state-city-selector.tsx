      ...
      <div className="grid w-full grid-cols-2 gap-x-3 gap-y-3 lg:grid-cols-2 mt-2">
        <div>
          <Controller
            ...
            render={({ field }) => (
              ...
              >
                <SelectTrigger className={cn("py-5 bg-primary-light-gray w-full ", className)}>
        ...
        <div>
          {selectedCountry ? (
            ...
            <Select>
              <SelectTrigger disabled className={cn("py-5 bg-primary-light-gray w-full ", className)}>
      ...
      <div className="grid w-full grid-cols-2 gap-x-3 gap-y-3 lg:grid-cols-3">
        ...
        <div className="col-span-2">
          <Input
            ...
            className={cn("outline-none focus:outline-none py-5 bg-primary-light-gray ", className)}
